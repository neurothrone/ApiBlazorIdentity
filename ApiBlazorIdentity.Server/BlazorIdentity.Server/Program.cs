using BlazorIdentity.Server.Components;
using BlazorIdentity.Server.Components.Account;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(BlazorIdentity.Wasm._Imports).Assembly);
